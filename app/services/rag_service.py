...
# **REMOVED** get_bm25_cache_key as we no longer cache the retriever itself.
...
class RAGService:
    ...
    def _invalidate_project_cache(self):
        ...
        try:
            ...
            # **FIX**: Only invalidate the cached list of documents.
    ...
    # **FIX**: This method now only loads from ChromaDB. Caching is handled by the caller.
    ...
    # **NEW**: A stable method to get all project docs, using a cache.
    ...
    def query(self, message: str) -> Tuple[str, List[Dict[str, Any]]]:
        ...
        # **FIX**: Use the new stable caching mechanism.
        ...
        # Build BM25 retriever in-memory (this is fast)
